...
class TerserPlugin {
  ...
  *taskGenerator(compiler, compilation, allExtractedComments, file) {
  ...
  apply(compiler) {
    ...
    this.options.sourceMap = typeof this.options.sourceMap === 'undefined' ? devtool && !devtool.includes('eval') && !devtool.includes('cheap') && (devtool.includes('source-map') || // Todo remove when `